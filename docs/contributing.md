...
- Contribute to zsh-devops repositories on [GitHub](https://github.com/hadenlabs/zsh-devops). See [GitHub flow](./contribute/github-flow.md).
...
Documentation is a part of the zsh-devops code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/hadenlabs/zsh-devops). This means that the contribution process is the same for both the source code and documentation.

<!-- Space: Projects -->
<!-- Parent: ZshDevOps -->
<!-- Title: Contributing GithubFlow ZshDevOps -->
<!-- Label: ZshDevOps -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-devops project on [GitHub](https://github.com/hadenlabs/zsh-devops), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-devops/pulls).
...
To follow the instructions in this guide and start contributing to zsh-devops project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-devops.git
```

Now your **upstream** points to **hadenlabs/zsh-devops**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-devops
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-devops/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
